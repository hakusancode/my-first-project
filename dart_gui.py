...
class DartApp(ctk.CTk):
    ...
    def _make_scroll_area(self, parent):
        """가로+세로 스크롤 가능한 영역 생성 → (container, inner_frame) 반환.
        inner_frame에 위젯을 배치하면 내용이 넘칠 때 스크롤바가 나타난다."""
        bg = ctk.ThemeManager.theme.get('CTkFrame', {}).get('fg_color', '#2b2b2b')
        ...
        vsb = ctk.CTkScrollbar(container, orientation='vertical', command=canvas.yview)
        vsb.grid(row=0, column=1, sticky='ns')
        hsb = ctk.CTkScrollbar(container, orientation='horizontal', command=canvas.xview)
    ...
    def _build_analysis(self, parent):
        ...
        _c, self._fin_content = self._make_scroll_area(fin_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._cf_content = self._make_scroll_area(cf_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._div_content = self._make_scroll_area(div_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._eqt_content = self._make_scroll_area(eqt_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._ratio_content = self._make_scroll_area(ratio_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._adt_content = self._make_scroll_area(adt_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._shr_content = self._make_scroll_area(shr_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._emp_content = self._make_scroll_area(emp_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
        ...
        _c, self._cap_content = self._make_scroll_area(cap_tab)
        _c.grid(row=1, column=0, sticky='nsew', padx=4, pady=4)
    ...
    def _build_us_panel(self, parent):
        self._us_container, self._us_frame = self._make_scroll_area(parent)
        self._us_container.grid(row=0, column=0, sticky='nsew', padx=8, pady=8)
